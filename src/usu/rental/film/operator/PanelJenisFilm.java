 ...
 * @author  usu
 */
public class PanelJenisFilm extends javax.swing.JPanel {

    /*
     * Serial version UID
     */
    private static final long serialVersionUID = 1L;
    private TableModelJenisFilm tableModel;
    private DefaultJenisFilm tempJenisFilm;

    /** Creates new form PanelDirektor */
    public PanelJenisFilm() {
        initVariables();
        initComponents();
        initFinals();
        initActions();
        ...
        table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                try {
                    ...
                    textId.setText(tableModel.get(index).getIdJenisFilm());
                    textNama.setText(tableModel.get(index).getNamaJenisFilm());
    ...
    public JenisFilm getJenisFilm() throws DataNotCompleteException {
        if (!textId.isEnabled()) {
        ...
        tempJenisFilm = new DefaultJenisFilm();
        tempJenisFilm.setIdJenisFilm(textId.getText());
        tempJenisFilm.setNamaJenisFilm(textNama.getText());
        return tempJenisFilm;
    }
    ...
    public TableModelJenisFilm getTableModel() {
        return tableModel;
    }

    private void initVariables() {
        tableModel = new TableModelJenisFilm();
    }
    ...
    private void initComponents() {
        ...
        label2.setText("id jenis film :");

        label3.setDisplayedMnemonic('N');
        label3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        label3.setText("nama jenis film :");
        ...
        panelGlass1Layout.setHorizontalGroup(
            ...
            .addGroup(panelGlass1Layout.createSequentialGroup()
                ...
                .addGroup(panelGlass1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(textId, javax.swing.GroupLayout.DEFAULT_SIZE, 481, Short.MAX_VALUE)
                    .addComponent(textNama, javax.swing.GroupLayout.DEFAULT_SIZE, 481, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelGlass1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
