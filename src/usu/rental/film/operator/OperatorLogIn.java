 ...
 * @author  usu
 */
public class OperatorLogIn extends Form {
     ...
     */
    public OperatorLogIn() throws IOException, ClassNotFoundException, SQLException {
    ...
    public Operator isOperator() {
        try {
            Operator temp = MySQL.containOperator(connection, textUsername.getText(), StringUtil.convertToString(textPassword.getPassword()));
            return temp;
    ...
    private void initComponents() {
        ...
        label2.setText("e'MovieRental : Operator");
        ...
        label1.setIconReflec(new javax.swing.ImageIcon(getClass().getResource("/usu/rental/film/resource/operator.png"))); // NOI18N
    ...
    private void initVariables() throws IOException, ClassNotFoundException, SQLException {

        form = new OperatorForm();

        FileInputStream in2 = new FileInputStream("setting\\emovierental.xml");

        Properties p = new Properties();
        p.loadFromXML(in2);

        setting = new Setting();
        setting.setDendaKeterlambatan(new Integer(p.getProperty("DENDA")));
        setting.setHargaPeminjaman(new Integer(p.getProperty("HARGA")));
        setting.setMaksimalPeminjaman(new Integer(p.getProperty("MAKSIMAL")));
    ...
    private void buttonMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMasukActionPerformed
        if (isOperator() != null) {
            ...
            traceArea.setText("koneksi gagal, cek kembali username dan password anda. " +
                    "jika anda lupa username atau password, silahkan hubungi administrator anda");
        }
