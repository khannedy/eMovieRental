 ...
 * @author  usu
 */
public class PanelAktivitasOperator extends javax.swing.JPanel {

    /*
     * Serial version UID
     */
    private static final long serialVersionUID = 1L;
    private TableModelAktivitasOperator tableModel;

    /** Creates new form PanelAnggota */
    public PanelAktivitasOperator() {
        initVariables();
        initComponents();
        initFinals();
        initActions();
    ...
    public TableModelAktivitasOperator getTableModel() {
        return tableModel;
    }
    ...
    private void initComponents() {
        ...
        buttonHapus.setMnemonic('K');
        buttonHapus.setText("kosongkan");
    ...
    private void initVariables() {
        tableModel = new TableModelAktivitasOperator();
    }
