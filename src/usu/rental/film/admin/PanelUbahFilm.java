 ...
 * @author  usu
 */
public class PanelUbahFilm extends javax.swing.JPanel {
    ...
    public void setConnection(Connection connection, Film data) throws SQLException, DataNotFoundException {
        data = MySQL.getFilmOriginal(connection, data.getIdFilm());
        textDirektor.setText(data.getDirektor());
        textIdFilm.setText(data.getIdFilm());
        textJenisFilm.setText(data.getJenisFilm());
        textJudulFilm.setText(data.getJudulFilm());
        textPemeran.setText(data.getPemeranUtama());
        textRumahProduksi.setText(data.getRumahProduksi());
