 ...
 * @author  usu
 */
public class PanelDirektor extends javax.swing.JPanel {

    /*
     * Serial version UID
     */
    private static final long serialVersionUID = 1L;
    private TableModelDirektor tableModel;
    private DefaultDirektor tempDirektor;

    /** Creates new form PanelDirektor */
    public PanelDirektor() {
        initVariables();
        initComponents();
        initFinals();
        initActions();
        ...
        table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                try {
                    ...
                    textId.setText(tableModel.get(index).getIdDirektor());
                    textNama.setText(tableModel.get(index).getNamaDirektor());
    ...
    public Direktor getDirektor() throws DataNotCompleteException {
        if (!textId.isEnabled()) {
            throw new DataNotCompleteException("textbox id ter-'disable'");
        }
        if (textId.getText().equals("")) {
            throw new DataNotCompleteException("id direktor masih kosong");
        }
        if (!textNama.isEnabled()) {
            throw new DataNotCompleteException("textbox nama ter-'disable'");
        }
        if (textNama.getText().equals("")) {
            throw new DataNotCompleteException("nama direktor masih kosong");
        }
        tempDirektor = new DefaultDirektor();
        tempDirektor.setIdDirektor(textId.getText());
        tempDirektor.setNamaDirektor(textNama.getText());
        return tempDirektor;
    }
    ...
    public TableModelDirektor getTableModel() {
        return tableModel;
    }

    private void initVariables() {
        tableModel = new TableModelDirektor();
    }
    ...
    private void initComponents() {
        ...
        label2.setText("id direktor :");

        label3.setDisplayedMnemonic('N');
        label3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        label3.setText("nama direktor :");
        ...
        panelGlass1Layout.setHorizontalGroup(
            ...
            .addGroup(panelGlass1Layout.createSequentialGroup()
                ...
                .addGroup(panelGlass1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(textId, javax.swing.GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE)
                    .addComponent(textNama, javax.swing.GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelGlass1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
