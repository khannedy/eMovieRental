 ...
 * @author  usu
 */
public class PanelRumahProduksi extends javax.swing.JPanel {

    /*
     * Serial version UID
     */
    private static final long serialVersionUID = 1L;
    private TableModelRumahProduksi tableModel;
    private DefaultRumahProduksi tempRumahProduksi;

    /** Creates new form PanelDirektor */
    public PanelRumahProduksi() {
        initVariables();
        initComponents();
        initFinals();
        initActions();
        ...
        table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                try {
                    ...
                    textId.setText(tableModel.get(index).getIdRumahProduksi());
                    textNama.setText(tableModel.get(index).getNamaRumahProduksi());
    ...
    public RumahProduksi getRumahProduksi() throws DataNotCompleteException {
        if (!textId.isEnabled()) {
            throw new DataNotCompleteException("textbox id ter-'disable'");
        }
        if (textId.getText().equals("")) {
            throw new DataNotCompleteException("id rumah produksi masih kosong");
        }
        if (!textNama.isEnabled()) {
            throw new DataNotCompleteException("textbox nama ter-'disable'");
        }
        if (textNama.getText().equals("")) {
            throw new DataNotCompleteException("nama rumah produksi masih kosong");
        }
        tempRumahProduksi = new DefaultRumahProduksi();
        tempRumahProduksi.setIdRumahProduksi(textId.getText());
        tempRumahProduksi.setNamaRumahProduksi(textNama.getText());
        return tempRumahProduksi;
    }
    ...
    public TableModelRumahProduksi getTableModel() {
        return tableModel;
    }

    private void initVariables() {
        tableModel = new TableModelRumahProduksi();
    }
    ...
    private void initComponents() {
        ...
        label2.setText("id rumah produksi :");

        label3.setDisplayedMnemonic('N');
        label3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        label3.setText("nama rumah produksi :");
        ...
        panelGlass1Layout.setHorizontalGroup(
            ...
            .addGroup(panelGlass1Layout.createSequentialGroup()
                ...
                .addGroup(panelGlass1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(textId, javax.swing.GroupLayout.DEFAULT_SIZE, 443, Short.MAX_VALUE)
                    .addComponent(textNama, javax.swing.GroupLayout.DEFAULT_SIZE, 443, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelGlass1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
