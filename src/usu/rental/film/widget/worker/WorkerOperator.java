 ...
 * @author usu
 */
public class WorkerOperator extends SwingWorker<List<Operator>, String> {

    private TableModelOperator model;
    private WorkerAction worker;
    private ResultSet result;

    public WorkerOperator(Connection connection, TableModelOperator model, WorkerAction worker) throws SQLException {
        this.model = model;
        this.worker = worker;
    ...
    public WorkerOperator(Connection connection, TableModelOperator model, WorkerAction worker,
    ...
    protected void done() {
        try {
            ...
            Logger.getLogger(WorkerOperator.class.getName()).log(Level.SEVERE, null, ex);
